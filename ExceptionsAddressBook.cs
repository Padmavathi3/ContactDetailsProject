...
namespace AddressBook
{
   /*class custom_exception : Exception
    ...
    class AddressBook
    {
        ...
        public static List<AddressBook> duplist=new List<AddressBook>();
        ...
        public void AddContact()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    {
                        throw new custom_exception("Your input is not matched so try again");
                    }
                }
                catch (Exception ex) 
                {
        ...
        public void EditContact()
        {
            ...
            Console.WriteLine("enter updated field value");
        ...
        public void SearchPerson()
        {
               ...
               for(int i = 0;i < listobj.Count;i++)
                {
                    ...
                    {
                        if ((listobj[i].City == listobj[j].City)|| (listobj[i].City == listobj[j].City))
                        {

                            if (!duplist.Contains(listobj[i]))
                            {
                                duplist.Add(listobj[i]);
                            }
           ...
           Console.WriteLine("display details");
            if (duplist.Count > 0)
            {
                foreach (AddressBook b in duplist)
                {
                    Console.WriteLine("Person Id: " + b.Id);
                    Console.WriteLine("Person FirstName: " + b.FirstName);
                    Console.WriteLine("Person LastName: " + b.LastName);
        ...
        {g
            Console.WriteLine("no.of contacts:"+listobj.Count);
            Console.WriteLine("do u want to check another option");
            string op = Console.ReadLine();
            if (op.ToLower() == "yes")
            {
